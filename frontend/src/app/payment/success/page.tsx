...
export default function PaymentSuccessPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 bg-gradient-to-br from-green-50 to-emerald-50 flex items-center justify-center py-12 px-4">
          ...
          <CardContent className="p-12 text-center">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8">
              <p className="text-sm text-blue-800">
                ...
                Booking Anda telah dikonfirmasi. Tutor akan segera menghubungi Anda melalui chat 
                untuk membahas detail kelas.
              </p>
            </div>
