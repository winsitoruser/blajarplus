...
export default function PaymentFailedPage() {
  ...
  const handleRetry = () => {
    if (payment?.booking?.id) {
      router.push(`/payment/${payment.booking.id}`);
    }
  };
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 bg-gradient-to-br from-red-50 to-pink-50 flex items-center justify-center py-12 px-4">
          ...
          <CardContent className="p-12 text-center">
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-8">
              <p className="text-sm text-red-800">
                <span className="font-semibold">Kemungkinan Penyebab:</span><br />
                • Saldo tidak mencukupi<br />
                • Kartu kredit ditolak<br />
                • Koneksi terputus saat transaksi<br />
